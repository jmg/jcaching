...
public class Cache {
    ...
    public Cache(Configuration configuration)
    	...
    	CacheBackendFactory<CacheBackend> backendFactory =
            new CacheBackendFactory<CacheBackend>(CacheBackend.class, configuration);

        backend = backendFactory.getObjectInstance();
    }
