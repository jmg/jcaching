...
public class JCachingAgent  {
	 static final Logger logger = LoggerFactory.getLogger(JCachingAgent.class);
	    ...
	    public static void premain(String args, Instrumentation inst) throws Exception {
	        ...
	        instrumentation.addTransformer(new JCachingTransformer());
	    }
